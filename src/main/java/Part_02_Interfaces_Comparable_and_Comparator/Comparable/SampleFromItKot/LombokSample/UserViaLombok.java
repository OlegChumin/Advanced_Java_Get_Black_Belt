 ...
 * Генерирует конструктор для полей, помеченных как final, и полей с аннотацией @NonNull.
 *
 * @AllArgsConstructor
 ...
 * та аннотация не только генерирует конструктор, но и предоставляет удобный API для построения объектов.
 */
